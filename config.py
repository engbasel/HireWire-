...
# Grace period: clients who joined within this many days are kept
# even if their hiring rate is 0% (they're brand-new, potentially serious)
NEW_CLIENT_DAYS: int = 5
...
def validate_config() -> bool:
    ...
    logger.info("   New Client Grace Period: %d days", NEW_CLIENT_DAYS)
